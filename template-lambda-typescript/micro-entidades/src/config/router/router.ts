<<<<<<< HEAD
//requests to be fulfilled by the API
...
export function routerApi(app: any) {// general function of the app's routes

    addGeneralMiddlewares(app)
    app.use("/country",countryRouter)                //the app uses the routes with the route functions of each entity
